...
package Java_Dlia_nashin_Zaur.L10.ИмпортИИмпортСтатик;

import Java_Dlia_nashin_Zaur.L09.РазновидностиПеременныхИПределыИхВидимости.Car; // испорт класса, вместо использования полного пути в паблик конструктору Java_shernii_poias.Lesson1.Lesson9.Car
import Java_Dlia_nashin_Zaur.L09.РазновидностиПеременныхИПределыИхВидимости.Student; // испорт класса, вместо использования полного пути в паблик конструктору Java_shernii_poias.Lesson1.Lesson9.Student
