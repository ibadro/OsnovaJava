...
package Zaur_Tregulov.Java_Dlia_nashin_Zaur.L05.КострукторОбьявлениеИВызовМетодов;
...
class HW5StudentTest {
    public static void main(String [] args) {
        ...
        HW5Student studentFromRussia = new HW5Student("Задачи/Alex", "Bondarev", 3, 333);
